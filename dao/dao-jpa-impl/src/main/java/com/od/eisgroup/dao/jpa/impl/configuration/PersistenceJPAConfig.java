package com.od.eisgroup.dao.jpa.impl.configuration;
...
/**
 * This class provides main configuration of the Persistence Layer of a EIS HR Project.
 *
...
public class PersistenceJPAConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactory.setPackagesToScan("com.od.eisgroup.domain.entity");
    ...
    private Properties additionalProperties() {
        ...
        // FIXME: this is a temporal if-statement.
        // Need to fix all issues and specify 'validate' value for 'hibernate.hbm2ddl.auto'
        String ddlGeneration = env.getProperty("hibernate.hbm2ddl.auto");
        if (ddlGeneration != null) {
            properties.put("hibernate.hbm2ddl.auto", ddlGeneration);
        }
        return properties;
    }
}
